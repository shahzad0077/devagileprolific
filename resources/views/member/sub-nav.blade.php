            ...
            <div class="flex-shrink-0 p-3 bg-white sub-nav" id="panel-new" style="width: 280px; margin-top: 5%;">
                ...
                <ul class="list-unstyled ps-0">
                    <li class="mb-1">
                        <a href="{{url('dashboard/organization/'.$Unit->slug.'/Value-Streams')}}" style="text-decoration: none;" class="" >
                        ...
                        <div class="collapse show" id="home-collapse" style="">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small px-3 py-2 nav-root-item">
                                ...
                                <li class="py-2"><a href="{{url('dashboard/organization/'.$value->slug.'/portfolio/'.$value->type)}}" class="link-dark rounded">{{$value->value_name}}</a></li>
                                @endforeach
                                @endif
                            </ul>
                        </div>
