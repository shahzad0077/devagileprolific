                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                                                ...
                                                                                <div class="card report-parent-card mb-3">
                                                                                    <div class="card-body">
                                                                                        <div class="d-flex flex-row justify-content-between align-items-center">
                                                                                            ...
                                                                                            <div class="d-flex flex-column content-area">
                                                                                                <div>
                                                                                                    @foreach($key as $k) <a href="{{url('dashboard/organization/report-2/'.$k->id.'/'.$r->id)}}"> @endforeach<h4>Epics Completed</h4></a>
                                                                                                </div>
                                                                                                <div>
                                                                                                    <p>Tracks completion of planned Epics for a Quarter against Objectives and Key Results.</p>
                                                                                                </div>
                                                                                            ...
                                                                                            <div class="d-flex flex-row">
                                                                                                <div class="mr-2"> 
                                                                                                 <a href="" class="btn btn-default">See Report</a>
                                                                                                </div>
                                                                                                <div><button class="btn btn-default">Download</button></div>
                                                                                            </div>
                                                                                        </div>
                                                    ...
                                                    @else
                                                    <button class="btn-circle btn-tolbar" data-toggle="tooltip" data-placement="top" title="Generate Report" onclick="endquarter();">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
