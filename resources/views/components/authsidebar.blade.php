<div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0 login-right-cont" style="background-image:url('{{asset('public/assets/images/info-graphics/bg-sidebar.png')}}'); ">
    <!--begin::Title-->
