...
<div class="row">
    <div class="col-md-12 col-lg-12 col-xl-12 @if($epicstory->count() > 1) paddingrightzero @endif">
        <div class="d-flex flex-row align-items-center justify-content-between block-header">
            <div>
                <h4><img src="{{ url('public/assets/svg/commentsmain.svg') }}"> Child Items</h4>
            </div>
            <div class="displayflex">
                <div class="dropdown firstdropdownofcomments">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" onclick="showorderby('desc',{{ $epic->id }},'flag_comments')" href="javascript:void(0)">Latest</a>
                    <a class="dropdown-item" onclick="showorderby('asc',{{ $epic->id }},'flag_comments')" href="javascript:void(0)">Older</a>
                  </div>
                </div>
